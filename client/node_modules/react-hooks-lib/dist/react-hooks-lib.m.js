...
var useFetch = function (initialUrl, initialOptions, ref) {
  ...
  var set = ref$2.set;
  var canFetchRef = useRef(onMount);
  useEffect(function () {
    var url = config.url;
...
var useOnlineStatus = function () {
  var ref = useState(navigator.onLine);
  var online = ref[0];
  var set = ref[1];
...
var useDidMount = function (f) { return useEffect(function () { return f && f(); }, []); };
...
var useWillUnmount = function (f) { return useEffect(function () { return function () { return f && f(); }; }, []); };
...
var createGlobalState = function (initial) {
  ...
  var context = createContext(initialStore);
  ...
  var GlobalProvider = function (ref) {
    ...
    return React.createElement( Provider, { value: initialStore },
      children
    );
  };
...
export { useToggle, useCounter, useHover, useActive, useFocus, useTouch, useList, useMap, useField, useFetch, useMergeState, useOnlineStatus, useDidMount, useDidUpdate, useWillUnmount, createGlobalState, createContextState, useUndo, useStateCallback, useShallowEqualEffect, useDeepEqualEffect, useAsync };
